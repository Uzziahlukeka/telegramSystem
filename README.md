...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/telegramSystem.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/telegramSystem)
...
```php
$telegramSystem = new uzhlaravel\TelegramSystem();
echo $telegramSystem->echoPhrase('Hello, uzhlaravel!');
```
...
- [Uzziah Lukeka](https://github.com/uzziahlukeka)
